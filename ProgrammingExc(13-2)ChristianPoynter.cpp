...
rectangleType operator+ (const rectangleType& leftRectangle, const rectangleType& rightRectangle)
{
	rectangleType sum;
	sum.length = leftRectangle.length + rightRectangle.length;
	sum.width = leftRectangle.width + rightRectangle.width;
...
{
	rectangleType sum;
	if (leftRectangle.length - rightRectangle.length >= 0 && leftRectangle.width - rightRectangle.width >= 0)
	{
		sum.length = leftRectangle.length - rightRectangle.length;
		sum.width = leftRectangle.width - rightRectangle.width;
	}
